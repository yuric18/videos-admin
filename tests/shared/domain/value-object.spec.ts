...
class ComplexValueObject extends ValueObject {
  constructor(readonly propr1: string, readonly prop2: number) {
    super()
  }
}
...
describe('ValueObject Unit Tests', () => {
  test('should be equal', () => {
    ...
    const complexValueObject1 = new ComplexValueObject('test', 0)
    const complexValueObject2 = new ComplexValueObject('test', 0)
